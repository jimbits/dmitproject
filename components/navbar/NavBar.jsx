...
function NavBar({ children, label, className }) {
	return (
		<nav className="flex justify-between py-2 px-4">
			<svg
				class="fill-gray-500  w-7 h-7"
				xmlns="http://www.w3.org/2000/svg"
				viewBox="0 0 500 500">
				<g>
					<path
						d="M352.7,139.9c12.7,10.3,22,21,29.8,32.9c18.9,28.4,28.9,59.9,26.9,93.9c-3.9,65.9-35.9,113.9-96.2,141.1
		...
		c1.5-13.7,2-27.6,2.2-41.3c0.3-30,0.1-60,0.1-90.1C352.7,147.5,352.7,144.6,352.7,139.9z"
					/>
					<path
						d="M259.6,26.4c-1.2,9.9-1.2,10-9.9,10c-48.3-0.1-92.2,14.2-131.2,42.4c-44.3,32-73.3,74.9-87.1,127.9
		...
		c32.5-31.7,71.4-52.2,116-61.8c17.1-3.7,34.3-4.7,51.7-4.8C255.4,25.7,257.3,26.1,259.6,26.4z"
					/>
					<path
						d="M274.9,39.8c0.3-20.2,17.8-38.1,37.2-37.8c22.5,0.3,39.3,17.1,38.9,38.9c-0.4,20.7-18.1,37.8-38.8,37.4
		C292.1,77.9,274.6,59.9,274.9,39.8z"
			...
			<span className="inline-flex gap-x-4 items-center">
				<Link
					href="/signin"
					className=" px-3 py-0.5 rounded-md bg-lime-200 text-lime-700 font-semibold text-xs ">
					login
				</Link>
				<Link
					href="/signup"
					className=" px-3 py-0.5 rounded-md bg-rose-200 text-rose-700 font-semibold text-xs ">
					sign up
				</Link>
			</span>
		</nav>
